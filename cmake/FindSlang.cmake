# $PRE_SLANG_DIR = ${slang/install/path}
if (PRE_SLANG_DIR)
    set(SLANG_LIB_PATH ${PRE_SLANG_DIR}/lib)
    set(SLANG_INCLUDE_PATH ${PRE_SLANG_DIR}/include)
    ...
    find_path(SLANG_INCLUDE_DIR "slang/compilation/Compilation.h" HINTS ${SLANG_INCLUDE_PATH})
else()
